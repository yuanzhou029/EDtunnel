...
let userID = "eaf548ff-54c9-4d2b-9964-f5ebffa3d514";

const proxyIPs = ["ipv6.yh-iot.cloudns.org"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
const cn_hostnames = [''];
let CDNIP = 'cdn.yh-iot.us.kg'
// http_ip
let IP1 = 'cdn.yh-iot.us.kg'
